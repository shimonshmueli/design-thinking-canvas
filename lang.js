...
const I18N = {
  ...
  "header.editTitle": { en: "✎ Edit", zh: "✎ 编辑" },
  "header.editTitle.title": { en: "Rename this project", zh: "重命名此项目" },
  "header.editTitle.leaderOnly": { en: "Only the team leader can rename the project", zh: "只有组长可以重命名项目" },
  ...
  // Team roster + identity switcher (team.js)
  "team.title": { en: "Team", zh: "团队" },
  "team.close": { en: "Close", zh: "关闭" },
  "team.soloHint": {
    en: "This project is solo right now — everything still works exactly as before. Starting a team adds a roster, per-member attribution, and a review step before anything is combined.",
    zh: "此项目目前为个人项目——一切功能照常运作。创建团队后，会新增成员名单、按成员署名，以及在合并任何内容前的审核步骤。",
  },
  "team.createLabel": { en: "Your name", zh: "你的姓名" },
  "team.createPlaceholder": { en: "e.g. Ana", zh: "例如：安娜" },
  "team.createButton": { en: "Start a team", zh: "创建团队" },
  "team.rosterHeading": { en: "Roster", zh: "成员名单" },
  "team.roleLeader": { en: "Leader", zh: "组长" },
  "team.roleMember": { en: "Member", zh: "成员" },
  "team.removeMember": { en: "Remove", zh: "移除" },
  "team.addMemberPlaceholder": { en: "Teammate's name", zh: "队友姓名" },
  "team.addMemberButton": { en: "Add", zh: "添加" },
  "team.leaderOnlyHint": { en: "Only the team leader can edit the roster and approval rule.", zh: "只有组长可以编辑成员名单和审批规则。" },
  "team.approvalRuleLabel": { en: "Approval rule", zh: "审批规则" },
  "team.approvalRuleLeader": { en: "Leader approves", zh: "组长审批" },
  "team.approvalRuleConsensus": { en: "Full team consensus", zh: "全体一致同意" },
  "team.actingAsLabel": { en: "Acting as", zh: "当前身份" },
  "team.actingAsHint": {
  ...
  "team.status.consolidating": { en: "Draft pending", zh: "草案待定" },
  "team.status.locked": { en: "Consolidated", zh: "已合并" },
  "team.readyYou": { en: "(you)", zh: "（你）" },
  "team.pickIdentity": { en: "Pick who you are for this project first — ", zh: "请先选择你在此项目中的身份 — " },
  "team.pickIdentityLink": { en: "open Team settings", zh: "打开团队设置" },
  "team.draftHeading": { en: "Consolidated draft (pending approval)", zh: "合并草案（待审批）" },
  "team.draftApprovals": { en: "Approvals:", zh: "已批准：" },
  "team.approveButton": { en: "Approve", zh: "批准" },
  "team.rejectButton": { en: "Reject, keep collecting", zh: "驳回，继续收集" },
  "team.reopenButton": { en: "Reopen this phase", zh: "重新开放此阶段" },
  "team.consolidateButton": { en: "Consolidate with AI", zh: "用 AI 合并" },
  ...
  "team.joinHeading": { en: "Join an existing team", zh: "加入现有团队" },
  "team.joinCodeLabel": { en: "Team code", zh: "团队代码" },
  "team.joinButton": { en: "Join", zh: "加入" },
  "team.working": { en: "Working…", zh: "处理中…" },
  "team.settingsRequired": { en: "Set your name in the Identity & AI tab first — your name (and the optional “about yourself” note) become your team identity.", zh: "请先在「身份与 AI」标签中填写你的姓名——你的姓名（以及可选的『关于你自己』说明）将成为你在团队中的身份。" },
  "team.canvasesHeading": { en: "Your canvases", zh: "你的画布" },
  "team.newCanvas": { en: "+ New solo canvas", zh: "+ 新建个人画布" },
  "team.canvasOpen": { en: "Open", zh: "打开" },
  "team.canvasCurrent": { en: "current", zh: "当前" },
  "team.canvasSolo": { en: "Solo", zh: "个人" },
  "team.canvasTeam": { en: "Team", zh: "团队" },
  "team.canvasDelete": { en: "Delete this canvas from your device", zh: "从你的设备中删除此画布" },
  "team.deleteCanvasConfirm": { en: "Delete this canvas from your device? This can't be undone. (If it's a team canvas, the team's copy on the server is unaffected.)", zh: "从你的设备中删除此画布？此操作无法撤销。（若为团队画布，服务器上团队的副本不受影响。）" },
  "team.createOnThisCanvas": { en: "Turns the canvas you're on now into a shared team project.", zh: "将你当前所在的画布转变为一个共享的团队项目。" },
  "team.leaveButton": { en: "Leave this team", zh: "退出此团队" },
  "team.leaveConfirm": { en: "Leave this team? You'll be removed from the roster for everyone, and this canvas becomes a solo one that keeps only the cards you added yourself.", zh: "退出此团队？你将从所有人的成员名单中被移除，此画布将变为个人画布，且仅保留你自己添加的卡片。" },
  "team.openSettings": { en: "⚙ Open Settings", zh: "⚙ 打开设置" },
  "team.joinAs": { en: "You'll join as", zh: "你将以此身份加入：" },
  "team.editInSettings": { en: "edit in Settings", zh: "在设置中修改" },
  ...
  "team.importPrompt": {
    ...
    zh: "此浏览器中已有一些卡片。是否将它们作为你在此团队项目中的贡献添加进去？",
  },
  "team.syncingHint": { en: "Connected — this project syncs across every device that joins with the code above.", zh: "已连接——此项目会在所有使用上方代码加入的设备间同步。" },
